...
const bodyText = computed(() => {
  return `${route.query.employees} Employees have been successfully invited to your ${route.query.subscription ? route.query.subscription : ''} subscription and their services will commence on ${formatDate(startdate.value, 'dd, mm do y')}`
})
