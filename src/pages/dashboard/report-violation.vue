  ...
  <div class="max-w-2xl col-10 mt-5  mx-auto bg-white shadow-md rounded-lg">
    ...
    <el-form :model="reportData" label-width="120px">
      ...
      <el-form-item label="Book (Optional)">
        <el-input v-model="reportData.book" placeholder="Book name (if applicable)" />
      </el-form-item>

      <el-form-item label="School (Optional)">
        <el-input v-model="reportData.school" placeholder="School name (if applicable)" />
      </el-form-item>

      <el-form-item label="Donor (Optional)">
        <el-input v-model="reportData.donor" placeholder="Donor name (if applicable)" />
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" @click="submitReport">Submit Report</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
