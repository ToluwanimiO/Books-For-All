  ...
  <div class="px-6 pb-5 w-80 m-auto">
    <el-card class="donation-form">
      ...
      <el-form :form="form" label-width="120px">
        <el-form-item class="" :label="'School Name'
                    " prop="first_name">
             ...
             <template v-if="!userAsContact">
                ...
                <el-col>
                  <el-form-item class="" label="Contact's First name" prop="first_name">
                    <el-input type="text" v-model="form.first_name" />
                  </el-form-item>
                </el-col>
                <el-col v-if="form.role !== 'school'">
                  <el-form-item class="" label="Contact's Last name" prop="last_name">
